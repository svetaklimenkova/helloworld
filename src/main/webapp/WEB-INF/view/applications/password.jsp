    ...
    <div class="container">
        <div class="row">
            <div class="my-form col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
                <form action="application/password" method="post">
                    ...
                    <div class="input">
                        ...
                        <input name="mail" type="email" id="mail" maxlength="255"/>
                        <span class="spin"></span>
                    </div>

                    <div class="button login">
                        <button type="submit"><spring:message code="form.application.send"/></button>
                    </div>
                </form>
            </div>
